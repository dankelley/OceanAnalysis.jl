...
p1 = histogram(sea_level, bins=10000, label=false, title="Sea-level [m]", titlefontsize=8)
p2 = histogram(sea_level_inch, bins=10000, label=false, title="Sea-level [m]", titlefontsize=8)

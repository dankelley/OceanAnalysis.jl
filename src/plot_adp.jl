...
```
"""
function plot_adp(adp::Adp, which=:velocity; debug=0, kwargs...)
    ...
    p1 = heatmap(x, y, transpose(v[:, :, 1]), title=titles[1],
        guidefontsize=8, tickfontsize=8, titlefontsize=8,
        size=(800, 600), ylab="Distance [m]",
        framestyle=:box, c=c, kwargs...)
    p2 = heatmap(x, y, transpose(v[:, :, 2]), title=titles[2],
        guidefontsize=8, tickfontsize=8, titlefontsize=8,
        size=(800, 600), ylab="Distance [m]",
        framestyle=:box, c=c, kwargs...)
    p3 = heatmap(x, y, transpose(v[:, :, 3]), title=titles[3],
        guidefontsize=8, tickfontsize=8, titlefontsize=8,
        size=(800, 600), ylab="Distance [m]",
        framestyle=:box, c=c, kwargs...)
    p4 = heatmap(x, y, transpose(v[:, :, 4]), title=titles[4],
        guidefontsize=8, tickfontsize=8, titlefontsize=8,
        size=(800, 600), ylab="Distance [m]",
        framestyle=:box, c=c, kwargs...)
